...
const idxComponent = require(`./idx-component${semis}`)
const classComponent = require(`./class-component${semis}`)
const pureComponent = require(`./pure-component${semis}`)
const testComponent = require(`./test-component${semis}`)
